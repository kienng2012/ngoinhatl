<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewsCategory.ascx.cs" Inherits="Web.Control.nmn.NewsCategory" %>
...
<div class="all_box">
    ...
    <div class="wrapper align-center">
        <ul id="portfolio-filter-standard" class="filter clearfix" data-related-grid="grid-du-an">
            ...
            <li><a data-option-value=".biet-thu" href="/tin-tuc/hien-dai.htm" title="Hiện đại">Hiện đại</a></li>
            <li><a data-option-value=".cafe-nha-hang-khach-san" href="phong-cach/scandinavian.htm" title="Scandinavian">Scandinavian</a></li>
            <li><a data-option-value=".can-ho" href="/tin-tuc/indochine.htm" title="Indochine">Indochine</a></li>
            <li><a data-option-value=".du-an-trang-chu" href="/tin-tuc/wabisabi.htm" title="Wabisabi">Wabisabi</a></li>
            <li><a data-option-value=".du-an-trang-chu" href="/tin-tuc/wabisabi.htm" title="Wabisabi">Wabisabi</a></li>
            <li><a data-option-value=".kien-truc" href="/tin-tuc/tan-co-dien.htm" title="Tân cổ điển">Tân cổ điển</a></li>
        </ul>
    </div>
    <div class="spacer spacer-small"></div>--%>
