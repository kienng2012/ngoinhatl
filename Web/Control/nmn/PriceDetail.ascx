                ...
                <div class="int_blog_box int_blog_single">
                            ...
                            <ItemTemplate>
                                ...
                                <div class="social-share-wrap">
                                    ...
                                    <ul class="social-share">
                                        <li>
                                            <a class="btn-social-icon btn-facebook" href="https://www.facebook.com/sharer/sharer.php?u=http://ngoinhatuonglai.vn/bao-gia/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm" target="_blank">
                                        ...
                                        <li>
                                            <a class="btn-social-icon btn-twitter" href="https://twitter.com/home?status=http://ngoinhatuonglai.vn/bao-gia/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm" target="_blank">
                                        ...
                                        <li>
                                            <a class="btn-social-icon btn-linkedin" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=http://ngoinhatuonglai.vn/bao-gia/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm&amp;title=<%# Eval("CS_Name") %>&amp;source=ngoinhatuonglai.vn" target="_blank">
                    ...
                    <%--<div class="int_blog_post">
                        <div class="all_box no-margin">
                            <div class="section-inner">
                                <div class="int_sidebar_box custom">
                                    <p class="title">DANH MỤC TIN TỨC KHÁC</p>
                        ...
                        <div class="int_blog_insta_post">
                            <ul>
                                <asp:Repeater ID="rptListCate" runat="server">
                                    <ItemTemplate>
                                        <li>
                                            <a href="/bao-gia/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm">
                                                <div class="img-related">
                                            ...
                                            <a class="project-name" href="/bao-gia/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm"><%#Eval("CS_Name")%></a>
                                        </li>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ul>
