<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Price.ascx.cs" Inherits="Web.Control.nmn.Price" %>
...
<section id="page-title" class="full-height" style="background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(<%= Page.ResolveClientUrl("~/App_Themes/house/img/bg_baogia.jpg")%>); background-size: cover; background-position: center center; background-repeat: no-repeat; min-height: 623px;">
    <div class="section-inner align-center">
        <div class="main-title">
            <h1 style="font-size: 28px; margin-top: 5px;"><strong>Báo giá</strong></h1>
        </div>
    </div>
</section>
<!-- END BANNER -->
...
<div class="breadcrumbs" typeof="BreadcrumbList" vocab="http://schema.org/">
    <div class="container">
        ...
        <span class="archive post-product-archive current-item">
            <a property="item" typeof="WebPage" title="Go to ARBARO." href="/bao-gia.htm" class="home"><span property="name">Báo giá</span></a>
        </span>
...
<div class="all_box">
    ...
    <div class="wrapper align-center">
        <ul id="portfolio-filter-standard" class="filter clearfix" data-related-grid="grid-du-an">
            <li><a class="active" data-option-value="*" href="/tin-tuc.htm">Tất cả</a></li>
            <li><a data-option-value=".biet-thu" href="/bao-gia/hoat-dong-arbaro.htm" title="">Hoạt động của Arbaro</a></li>
            <li><a data-option-value=".cafe-nha-hang-khach-san" href="/bao-gia/tuyen-dung.htm" title="">Tuyển dụng</a></li>
            <li><a data-option-value=".can-ho" href="/bao-gia/blog-noi-that.htm" title="">Blog nội thất</a></li>
            <li><a data-option-value=".du-an-trang-chu" href="/bao-gia/tin-tuc-khac.htm" title="">Tin tức khác</a></li>
            <li><a data-option-value=".du-an-trang-chu" href="/bao-gia/tin-tuc-khac.htm" title="">Tin tức khác</a></li>
        </ul>
    </div>
    <div class="spacer spacer-small"></div>--%>
        ...
        <asp:Repeater ID="rptListCate" runat="server">
            <ItemTemplate>
                <div class="item_pro">
                    ...
                    <a href="/bao-gia/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm" class="link_full"></a>
                </div>
