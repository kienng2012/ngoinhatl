...
{
    public partial class RecruitmentDetail : System.Web.UI.UserControl
    {
        protected int _intCateID = 14;
        ...
        public void LoadDataByCateSubID()
        {
            ...
            else
            {
                ...
                this.LoadDataByProjectWithoutCurrentID(_intCateID, _serviceID);
            }
        }
