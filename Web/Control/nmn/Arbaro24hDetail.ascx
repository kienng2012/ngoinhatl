<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Arbaro24hDetail.ascx.cs" Inherits="Web.Control.nmn.Arbaro24hDetail" %>
...
<div class="breadcrumbs" typeof="BreadcrumbList" vocab="http://schema.org/">
    ...
    <span class="archive post-product-archive current-item">
        <a property="item" typeof="WebPage" title="Go to ARBARO." href="/arbaro24h.htm" class="home"><span property="name">Arbaro 24h</span></a>
    </span>
</div>
                            ...
                            <ItemTemplate>
                                ...
                                <div class="social-share-wrap">
                                    ...
                                    <ul class="social-share">
                                        <li>
                                            <a class="btn-social-icon btn-facebook" href="https://www.facebook.com/sharer/sharer.php?u=http://ngoinhatuonglai.vn/arbaro24h/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm" target="_blank">
                                        ...
                                        <li>
                                            <a class="btn-social-icon btn-twitter" href="https://twitter.com/home?status=http://ngoinhatuonglai.vn/arbaro24h/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm" target="_blank">
                                        ...
                                        <li>
                                            <a class="btn-social-icon btn-linkedin" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=http://ngoinhatuonglai.vn/arbaro24h/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm&amp;title=<%# Eval("CS_Name") %>&amp;source=ngoinhatuonglai.vn" target="_blank">
                                ...
                                <asp:Repeater ID="rptListCate" runat="server">
                                    <ItemTemplate>
                                        <li>
                                            ...
                                            <a class="project-name" href="/arbaro24h/<%# RewriteUrl.ConvertToUnSign(Eval("CS_Name").ToString()) %>-<%#Eval("CS_ID") %>.htm"><%#Eval("CS_Name")%></a>
                                        </li>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </ul>
